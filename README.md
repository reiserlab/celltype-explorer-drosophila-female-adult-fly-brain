# Female Adult Fly Brain – Cell Type Explorer - Dataset Documentation

**Dataset:** flywire-fafb:v783b
**Server:** neuprint-cns.janelia.org
**Dataset UUID:** v783b
**Dataset Last Updated:** unknown
**Generated:** 2026-05-08 13:56:54 UTC
...
4. The generation date of this catalog (2026-05-08)
...
*This catalog was automatically generated from neuPrint data on 2026-05-08 at 13:56:54 UTC using dataset flywire-fafb:v783b (UUID: v783b, last updated: unknown). For the most up-to-date information, please consult the original neuPrint database.*